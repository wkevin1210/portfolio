            ...
            <div className="hero-section-content-box about-section-box">
                <div className="hero-section-content">
                    ...
                    <p className="about-me-description">
                        I am a data scientist and analyst with a unique blend of technical expertise and creative problem-solving, backed by a bachelor’s degree from Carnegie Mellon University in statistics & machine learning with an additional major in creative writing,
                        and a master’s degree from the University of Southern California in applied data science.
                    ...
                    <p className="about-me-description">
                        In addition to these experiences, I am constantly engaging in personal projects to continue to develop and expand my skills in data science and beyond. A selection of these projects can be found in my portfolio below.
                    </p>
                </div>
            </div>
        </section>
